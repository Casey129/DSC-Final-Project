...
st.markdown("""
This project will explore how students lifestyle choices affect mental health and burnout. 
Through the five questions we chose to explore, we investigated sleep, exam pressure, physical activity, 
social support, and financial stress on student wellbeing
            """)
...
with st.expander("📋 About This Dataset"):
    st.markdown("""
                **Data Source:** Student Lifestyle, Mental Health & Burnout Insight — [Kaggle](https://www.kaggle.com/datasets/ayeshasiddiqa123/student-health
                ...
                **Pre-Processing:**
                - The data was too large so we had to create a smaller sample size.
                - There were no significant missing values or outliers. 
                - We chose a color pallete that fit the color accessibility chart. 
                - All charts respond to the sample size slider and academic year filter accordingly   
                """)
...
with tab6:
    ...
    st.markdown("""
    - Sleep is a major lifestyle factor and it affects students mental health and stress
    - Mental health can cause more pressure, but it determines how well students cope, not pressure alone
    - Active students who sleep enough consistently show the best mental health outcomes
    - Social support can act as a buffer against burnout
    - Financial stress and family pressure combined can create higher mental health issues 
            """)